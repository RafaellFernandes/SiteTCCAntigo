...
<html lang="pt-BR">
   ...
   <div class="card text-center mt-5 mr-5 ml-5">
      ...
      <div class="card-body">
         <h5 class="card-title">Deseja Fazer Logout?</h5>
            <?php 
               session_start();
               ...
               <a class="btn btn-danger" href= "sairConta.php?token='.$token.'">Confirmar logout</a>
               </div>';
               }
            ?>
         <div class="alert alert-info" role="alert">
            <a href="home" class="btn btn-info">Cancelar</a>
         </div>
      </div>
