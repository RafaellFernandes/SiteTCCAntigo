...
<div class="container-fluid">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
				<h1 class="float-left">Cadastrar Usuario</h1>
				<div class="float-right">
					<a href="listar/usuario" class="btn btn-primary">Listar Registros</a>
				</div>

				<div class="clearfix"></div>
				<br>
				<form name="formCadastro" method="post"
				action="salvar/usuario" data-parsley-validate enctype="multipart/form-data">
