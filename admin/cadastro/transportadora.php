...
<div class="container-fluid">
    ...
    <div class="content-wrapper">
        ...
        <div class="content-header">
            <div class="container-fluid">
				<h1 class="float-left">Cadastrar Transportadora</h1>
				<div class="float-right">
					<a href="listar/transportadora" class="btn btn-primary">Listar Registros</a>
				</div>

				<div class="clearfix"></div>
				<br>
				<form name="formCadastro" method="post"
				action="salvar/transportadora" data-parsley-validate enctype="multipart/form-data">
				<p>* Campos Obrigatórios</p>
					<div class="row">
						...
						<div class="col-12 col-md-4">
							...
							<input type="text" name="Telefone" id="Telefone" class="form-control" placeholder="Com DDD e sem espaços"
							value="<?=$Telefone;?>">
						</div>
						<div class="col-12 col-md-4">
						...
						<div class="col-12 col-md-4">
							...
							value="<?=$cep;?>" placeholder="12345-678">
						</div>
						<div class="col-12 col-md-2">
						...
						<div class="col-12 col-md-4">
							...
							value="<?=$nome_cidade;?>" placeholder="Cidade" readonly>
						</div>
						<div class="col-12 col-md-2">
						...
						<div class="col-12 col-md-4">
							...
							value="<?=$Endereco;?>" placeholder="Av.Paraná, 2801">
						</div>
					</div>
					<br>
